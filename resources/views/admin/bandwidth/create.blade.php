...
@section('page-title', 'Create Bandwidth Policy')
@section('page-description', 'Add a new bandwidth policy')

@section('content')
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <div class="p-6 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-800">New Bandwidth Policy</h3>
        </div>
        
        <form action="{{ route('admin.bandwidth.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <input type="number" id="download_speed" name="download_speed" value="{{ old('download_speed') }}" required min="1"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    placeholder="50">
            ...
            <div>
                ...
                <input type="number" id="upload_speed" name="upload_speed" value="{{ old('upload_speed') }}" required min="1"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    placeholder="25">
                @error('upload_speed')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            ...
            <div>
                ...
                <input type="number" id="data_cap" name="data_cap" value="{{ old('data_cap') }}" min="1"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
